...
const Hero = () => {
  return (<div className="border-b border-neutral-900 pb-4 lg:mb-35">
    ...
    <div className="flex justify-center">
      <motion.img initial={{x:100, opacity:0}} animate={{x:0, opacity:1}} transition={{duration:1, delay: 1.2}} className="rounded-2xl" src={profilePic} alt="Sahil's profile picture" style={{ width: '500px', height: '500px' }} />
    </div>
    </div>
    </div>
    </div>
